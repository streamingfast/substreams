...
**Estimate mode maximum block range**
- **Purpose**: Set maximum block range allowed when using estimate_mode for cost estimation
- **Usage**: Set as unsigned integer to limit the number of blocks that can be processed in estimate_mode
- **Default**: 1000
