	...
	tests := []struct {
	...
	}{
		{
			...
			want: map[string][]byte{
				...
				"src/lib.rs":            fileContent(t, "./ethereum/results/nosink/lib.rs"),
				"build.rs":              fileContent(t, "./ethereum/build.rs"),
				"Cargo.lock":            fileContent(t, "./ethereum/Cargo.lock"),
				"Cargo.toml":            fileContent(t, "./ethereum/results/nosink/Cargo.toml"),
		...
		},
		{
			...
			want: map[string][]byte{
				...
				"src/pb/contract.v1.rs": fileContent(t, "./ethereum/src/pb/contract.v1.rs"),
				"src/pb/mod.rs":         fileContent(t, "./ethereum/src/pb/mod.rs"),
				"src/lib.rs":            fileContent(t, "./ethereum/results/dbsink/lib.rs"),
				"build.rs":              fileContent(t, "./ethereum/build.rs"),
				"Cargo.lock":            fileContent(t, "./ethereum/Cargo.lock"),
				"Cargo.toml":            fileContent(t, "./ethereum/results/dbsink/Cargo.toml"),
				"Makefile":              fileContent(t, "./ethereum/Makefile"),
		...
		},
		{
			...
			want: map[string][]byte{
				...
				"src/pb/contract.v1.rs": fileContent(t, "./ethereum/src/pb/contract.v1.rs"),
				"src/pb/mod.rs":         fileContent(t, "./ethereum/src/pb/mod.rs"),
				"src/lib.rs":            fileContent(t, "./ethereum/results/graphsink/lib.rs"),
				"build.rs":              fileContent(t, "./ethereum/build.rs"),
				"Cargo.lock":            fileContent(t, "./ethereum/Cargo.lock"),
				"Cargo.toml":            fileContent(t, "./ethereum/results/graphsink/Cargo.toml"),
				"Makefile":              fileContent(t, "./ethereum/Makefile"),
