...
* [Consume Substreams](new/consume/introduction.md)
  ...
  * [Substreams:SQL](new/consume/sql/introduction.md)
    * [Deployable Service](new/consume/sql/deployable-services/introduction.md)
      * [Hosted Service](new/consume/sql/deployable-services/hosted-service.md)
      * [Local Service](new/consume/sql/deployable-services/local-service.md)
    * [PostgresSQL Sink (non-deployable service)](new/consume/sql/postgres-sink.md)
