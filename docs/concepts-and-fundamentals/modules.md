...
Modules are an important part of Substreams. Modules provide hooks into the execution of the Substreams compute engine. You craft Substreams data manipulation and transformation strategies within modules.
