...
<img src="../.gitbook/assets/gui/run.png" width="100%" />
...
<img src="../.gitbook/assets/gui/gui.png" width="100%" />
...
<img src="../.gitbook/assets/gui/launching.gif" width="100%" />
...
<img src="../.gitbook/assets/gui/tabs.gif" width="100%" />

You can restart the stream by pressing the `s` key.

<img src="../.gitbook/assets/gui/restart.gif" width="100%" />
...
<img src="../.gitbook/assets/gui/output.png" width="100%" />
...
<img src="../.gitbook/assets/gui/navigating-blocks.gif" width="100%" />

If you want to jump to a specific block, you can press the `=` and specify the block number. Then, just press `enter`.

<img src="../.gitbook/assets/gui/jump-to-block.gif" width="100%" />
...
<img src="../.gitbook/assets/gui/navigating-modules.gif" width="100%" />

You can also search for a specific block using the 
...
<img src="../.gitbook/assets/gui/search.gif" width="100%" />
