...
The Substreams CLI allows you to run, package, and visualize your Substreams. Make sure you have the CLI installed by following the [Install Substreams CLI](../../../cli/installing-the-cli.md) instructions or use our [Dev Container](../../../../references/devcontainer-ref.md) to setup your environment.
