...
First, you must consider whether you want to develop your own Substreams or consume a ready-to-use Substreams. It is possible that someone has already built a Substreams package to extract the data you want; you can explore Substreams package in the [Substreams Registry](https://substreams.dev).

**If you have found a Substreams package that fits your needs**, then explore the _Consume Substreams_ section of the documentation. At the most basic level you should:
...
**If you can't find a Substreams package that fits your needs**, then you can go ahead an develop your own Substreams. The _Develop Substreams_ section of the documentation covers everything you need to know about building a Substreams from scratch. At the most basic level, you should:
...
If you want to deep dive into the code, you follow one or several of the Solana Tutorials available in the documentation. A good way to start is to complete the [Explore Solana Tutorial](../tutorials/solana/explore-solana/explore-solana.md)

## The Solana Data Model

A Substreams module is, essentially, a Rust function that extracts data from the blockchain. In order to specify which data you want to retrieve, Substreams gives you access the abstraction of a full [Solana block](https://github.com/streamingfast/firehose-solana/blob/develop/proto/sf/solana/type/v1/type.proto#L9).
...
The [Block] object holds other important information, such as:
