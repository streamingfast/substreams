	...
	tests := []struct {
...

		{
			...
			hashes: map[string]string{
				...
				// "uniswapv3:graph_out":                    "6ee6652ef66a55a5f9081fab9e5d0d71bdd9a3af", // not used
				...
				// "uniswapv3:store_derived_factory_tvl":    "285cb4af8009d3f74eda50922018dea4ed093eb6", // not used
				...
				// "uniswapv3:store_max_windows":            "f00616fd3fe54c72350d45eea499e4fa3b98583e", // not used
				// "uniswapv3:store_min_windows":            "e924c7a10c688dc70eb86eb10960bc6d5a0c75d6", // not used
				"uniswapv3:store_native_amounts": "3f2d5d0e4ea7611d05c5d78d8b83220fadb8dc67",
				// "uniswapv3:store_pool_count":             "804bd4401819845e25f84372e2ca7956755a6916", // not used
				"uniswapv3:store_pool_liquidities": "fbd8752e9ed4e21deb4e576e159a9cff8ad768f6",
				// "uniswapv3:store_pool_sqrt_price":        "0d07ee6b821db6c2174a23ad401e92384e88aa96", // not used
				"uniswapv3:store_pools_created": "65da4dab1cf1556cb649da4d8ba4102a8af0572d",
				// "uniswapv3:store_positions":              "c727fb136b06f2b436dd967e3a9dd84af63c2a86", // not used
				...
				// "uniswapv3:store_ticks_liquidities":      "303ee913f3180f7d882d90e686471950dee281d2", // not used
				"uniswapv3:store_token_tvl": "76a5918a733d131eb6d90111ab52d9660220ad88",
				// "uniswapv3:store_tokens":                 "e6f833dba48a6cbb24d6cf7feb870e2fb58bf6e8", // not used
		...
		{
			file: "testdata/with-use.yaml", // we import a HUGE uniswapv3_first module, but only depend on a single of their modules, testing the 'removeUnusedImportedModules` at the same time
			hashes: map[string]string{
				"new_map_pools_created": "5c7cc2287d6bead1da553aa147153339eee46bdc",
			},
		},
		{
