...
func TestWasmMetricsGatherer_RecordsDoneCalls(t *testing.T) {
	...
	id := gatherer.RecordModuleWasmExternalCallBegin("mod", "eth:call")
	gatherer.RecordModuleWasmExternalCallEnd("mod", "eth:call", id)
...
func TestWasmMetricsGatherer_ApplyToStats(t *testing.T) {
	...
	id := gatherer.RecordModuleWasmExternalCallBegin("mod", "eth:balance")
	gatherer.RecordModuleWasmExternalCallEnd("mod", "eth:balance", id)
...
func TestWasmMetricsGatherer_EndWithoutBeginNilLogger(t *testing.T) {
	...
	assert.NotPanics(t, func() {
		gatherer.RecordModuleWasmExternalCallEnd("mod", "eth:call", 42)
	})
