...
func (x *UserInput) GetLocalFile() *UserInput_LocalFile {
	if x != nil {
		if x, ok := x.Entry.(*UserInput_LocalFile_); ok {
			return x.LocalFile
		}
	}
	return nil
...
func (x *SystemOutput) GetLocalFile() *SystemOutput_LocalFile {
	if x != nil {
		if x, ok := x.Entry.(*SystemOutput_LocalFile_); ok {
			return x.LocalFile
		}
	}
	return nil
...
func file_sf_codegen_conversation_v1_conversation_proto_init() {
	...
	file_sf_codegen_conversation_v1_conversation_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
