...
const file_sf_codegen_conversation_v1_conversation_proto_rawDesc = "" +
	"\n" +
	"-sf/codegen/conversation/v1/conversation.proto\x12\x1asf.codegen.conversation.v1\"\a\n" +
	"\x05Empty\"\x9d\n" +
	"\n" +
	"\tUserInput\x12\x15\n" +
	"\x06msg_id\x18\x01 \x01(\rR\x05msgId\x12\x1e\n" +
	"\vfrom_msg_id\x18\x02 \x01(\rR\tfromMsgId\x12$\n" +
	"\x0efrom_action_id\x18\x03 \x01(\tR\ffromActionId\x12C\n" +
	"\x05start\x18\v \x01(\v2+.sf.codegen.conversation.v1.UserInput.StartH\x00R\x05start\x12P\n" +
	"\n" +
	"text_input\x18\x0f \x01(\v2/.sf.codegen.conversation.v1.UserInput.TextInputH\x00R\ttextInput\x12O\n" +
	"\tselection\x18\x11 \x01(\v2/.sf.codegen.conversation.v1.UserInput.SelectionH\x00R\tselection\x12X\n" +
	"\fconfirmation\x18\x12 \x01(\v22.sf.codegen.conversation.v1.UserInput.ConfirmationH\x00R\fconfirmation\x12B\n" +
	"\x04file\x18\x10 \x01(\v2,.sf.codegen.conversation.v1.UserInput.UploadH\x00R\x04file\x12b\n" +
	"\x10downloaded_files\x18\x14 \x01(\v25.sf.codegen.conversation.v1.UserInput.DownloadedFilesH\x00R\x0fdownloadedFiles\x12P\n" +
	"\n" +
	"local_file\x18\x15 \x01(\v2/.sf.codegen.conversation.v1.UserInput.LocalFileH\x00R\tlocalFile\x1a!\n" +
	"\tTextInput\x12\x14\n" +
	...
	"\x06_error\x1a\x8d\x01\n" +
	"\x05Start\x12!\n" +
	"\fgenerator_id\x18\x01 \x01(\tR\vgeneratorId\x12G\n" +
	"\ahydrate\x18\x02 \x01(\v2-.sf.codegen.conversation.v1.UserInput.HydrateR\ahydrate\x12\x18\n" +
	"\aversion\x18\x03 \x01(\rR\aversion\x1a\x97\x01\n" +
	"\aHydrate\x12\x1f\n" +
	"\vsaved_state\x18\x01 \x01(\tR\n" +
	"savedState\x12\x1c\n" +
	"\tsignature\x18\x02 \x01(\fR\tsignature\x12\x1e\n" +
	"\vlast_msg_id\x18\x03 \x01(\rR\tlastMsgId\x12-\n" +
	"\x12reset_conversation\x18\x04 \x01(\bR\x11resetConversation\x1a[\n" +
	"\x06Upload\x12\x1b\n" +
	"\tmime_type\x18\x01 \x01(\tR\bmimeType\x12\x1a\n" +
	"\bfilename\x18\x02 \x01(\tR\bfilename\x12\x18\n" +
	"\acontent\x18\x03 \x01(\fR\acontent\x1a7\n" +
	"\tSelection\x12\x14\n" +
	"\x05label\x18\x01 \x01(\tR\x05label\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x1a0\n" +
	"\fConfirmation\x12 \n" +
	"\vaffirmative\x18\x01 \x01(\bR\vaffirmative\x1a\x11\n" +
	"\x0fDownloadedFilesB\a\n" +
	"\x05entry\"\x9a\x14\n" +
	"\fSystemOutput\x12\x15\n" +
	"\x06msg_id\x18\x01 \x01(\rR\x05msgId\x12\x1e\n" +
	"\vfrom_msg_id\x18\x02 \x01(\rR\tfromMsgId\x12\x1b\n" +
	"\taction_id\x18\x03 \x01(\tR\bactionId\x12\x14\n" +
	"\x05state\x18\x04 \x01(\tR\x05state\x12'\n" +
	"\x0fstate_signature\x18\x05 \x01(\fR\x0estateSignature\x12L\n" +
	"\amessage\x18\x0f \x01(\v20.sf.codegen.conversation.v1.SystemOutput.MessageH\x00R\amessage\x12`\n" +
	"\x0fimage_with_text\x18\x10 \x01(\v26.sf.codegen.conversation.v1.SystemOutput.ImageWithTextH\x00R\rimageWithText\x12V\n" +
	"\vlist_select\x18\x11 \x01(\v23.sf.codegen.conversation.v1.SystemOutput.ListSelectH\x00R\n" +
	"listSelect\x12S\n" +
	"\n" +
	"text_input\x18\x12 \x01(\v22.sf.codegen.conversation.v1.SystemOutput.TextInputH\x00R\ttextInput\x12L\n" +
	"\aconfirm\x18\x15 \x01(\v20.sf.codegen.conversation.v1.SystemOutput.ConfirmH\x00R\aconfirm\x12L\n" +
	"\aloading\x18\x13 \x01(\v20.sf.codegen.conversation.v1.SystemOutput.LoadingH\x00R\aloading\x12_\n" +
	"\x0edownload_files\x18\x14 \x01(\v26.sf.codegen.conversation.v1.SystemOutput.DownloadFilesH\x00R\rdownloadFiles\x12S\n" +
	"\n" +
	"local_file\x18\x16 \x01(\v22.sf.codegen.conversation.v1.SystemOutput.LocalFileH\x00R\tlocalFile\x1a;\n" +
	"\aMessage\x12\x1a\n" +
	"\bmarkdown\x18\x01 \x01(\tR\bmarkdown\x12\x14\n" +
	"\x05style\x18\x02 \x01(\tR\x05style\x1aD\n" +
	"\rImageWithText\x12\x17\n" +
	"\aimg_url\x18\x01 \x01(\tR\x06imgUrl\x12\x1a\n" +
	"\bmarkdown\x18\x02 \x01(\tR\bmarkdown\x1a\x8f\x03\n" +
	"\n" +
	"ListSelect\x12\x0e\n" +
	...
	"\finstructions\x18\x06 \x01(\tR\finstructions\x12\x1f\n" +
	"\vselect_many\x18\b \x01(\bR\n" +
	"selectMany\x12_\n" +
	"\vselect_type\x18\a \x01(\x0e2>.sf.codegen.conversation.v1.SystemOutput.ListSelect.SelectTypeR\n" +
	"selectType\x12.\n" +
	"\x13select_button_label\x18\x05 \x01(\tR\x11selectButtonLabel\x12#\n" +
	"\rdefault_value\x18\t \x01(\tR\fdefaultValue\"'\n" +
	"\n" +
	"SelectType\x12\f\n" +
	"\bDROPDOWN\x10\x00\x12\v\n" +
	"\aBUTTONS\x10\x01\x1a\xf0\x02\n" +
	"\tTextInput\x12\x16\n" +
	"\x06prompt\x18\b \x01(\tR\x06prompt\x12 \n" +
	"\vdescription\x18\x01 \x01(\tR\vdescription\x12 \n" +
	"\vplaceholder\x18\x02 \x01(\tR\vplaceholder\x12#\n" +
	"\rdefault_value\x18\t \x01(\tR\fdefaultValue\x12\x1d\n" +
	"\n" +
	"multi_line\x18\x03 \x01(\x05R\tmultiLine\x12+\n" +
	"\x11validation_regexp\x18\x04 \x01(\tR\x10validationRegexp\x128\n" +
	"\x18validation_error_message\x18\x05 \x01(\tR\x16validationErrorMessage\x12.\n" +
	"\x13submit_button_label\x18\x06 \x01(\tR\x11submitButtonLabel\x12,\n" +
	"\x12submit_button_icon\x18\a \x01(\tR\x10submitButtonIcon\x1a\xea\x01\n" +
	"\tLocalFile\x12\x16\n" +
	"\x06prompt\x18\b \x01(\tR\x06prompt\x12 \n" +
	"\vdescription\x18\x01 \x01(\tR\vdescription\x12 \n" +
	"\vplaceholder\x18\x02 \x01(\tR\vplaceholder\x12#\n" +
	...
	"\x13submit_button_label\x18\x06 \x01(\tR\x11submitButtonLabel\x12,\n" +
	"\x12submit_button_icon\x18\a \x01(\tR\x10submitButtonIcon\x1a9\n" +
	"\aLoading\x12\x18\n" +
	"\aloading\x18\x01 \x01(\bR\aloading\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x1a\\\n" +
	"\rDownloadFiles\x12K\n" +
	"\x05files\x18\x01 \x03(\v25.sf.codegen.conversation.v1.SystemOutput.DownloadFileR\x05files\x1az\n" +
	"\fDownloadFile\x12\x1a\n" +
	"\bfilename\x18\x01 \x01(\tR\bfilename\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x18\n" +
	"\acontent\x18\x03 \x01(\fR\acontent\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x1a\xb4\x02\n" +
	"\aConfirm\x12\x16\n" +
	"\x06prompt\x18\x01 \x01(\tR\x06prompt\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12.\n" +
	"\x13accept_button_label\x18\x02 \x01(\tR\x11acceptButtonLabel\x120\n" +
	"\x14decline_button_label\x18\x03 \x01(\tR\x12declineButtonLabel\x12^\n" +
	"\x0edefault_button\x18\x05 \x01(\x0e27.sf.codegen.conversation.v1.SystemOutput.Confirm.ButtonR\rdefaultButton\"-\n" +
	"\x06Button\x12\t\n" +
	...
	"\fsearch_terms\x18\x01 \x01(\tR\vsearchTerms\x12%\n" +
	"\x0eclient_version\x18\x02 \x01(\x04R\rclientVersion\"\x8f\x02\n" +
	"\x11DiscoveryResponse\x12W\n" +
	"\n" +
	"generators\x18\x01 \x03(\v27.sf.codegen.conversation.v1.DiscoveryResponse.GeneratorR\n" +
	"generators\x1a\xa0\x01\n" +
	"\tGenerator\x12\x0e\n" +
	...
	"\x05group\x18\x06 \x01(\tR\x05group2\xdf\x01\n" +
	"\x13ConversationService\x12_\n" +
	"\bConverse\x12%.sf.codegen.conversation.v1.UserInput\x1a(.sf.codegen.conversation.v1.SystemOutput(\x010\x01\x12g\n" +
	"\bDiscover\x12,.sf.codegen.conversation.v1.DiscoveryRequest\x1a-.sf.codegen.conversation.v1.DiscoveryResponseB&Z$sf/codegen/conversation;conversationb\x06proto3"
