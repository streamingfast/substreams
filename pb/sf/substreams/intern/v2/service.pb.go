...
type ProcessRangeRequest struct {
	...
	FoundationalStoreEndpoints      map[string]string `protobuf:"bytes,18,rep,name=foundational_store_endpoints,json=foundationalStoreEndpoints,proto3" json:"foundational_store_endpoints,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *ProcessRangeResponse) GetBlockScopedData() *BlockScopedData {
	if x, ok := x.GetType().(*ProcessRangeResponse_BlockScopedData); ok {
...
func file_sf_substreams_intern_v2_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sf_substreams_intern_v2_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
