...
package pbsubstreamsrpcv3connect
...
const (
	...
	StreamName = "sf.substreams.rpc.v3.Stream"
)
...
const (
	...
	StreamBlocksProcedure = "/sf.substreams.rpc.v3.Stream/Blocks"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	streamServiceDescriptor      = v3.File_sf_substreams_rpc_v3_service_proto.Services().ByName("Stream")
...
// NewStreamClient constructs a client for the sf.substreams.rpc.v3.Stream service. By default, it
...
func NewStreamClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) StreamClient {
	...
	return &streamClient{
		blocks: connect.NewClient[v3.Request, v2.Response](
			httpClient,
...
type streamClient struct {
	blocks *connect.Client[v3.Request, v2.Response]
}

// Blocks calls sf.substreams.rpc.v3.Stream.Blocks.
func (c *streamClient) Blocks(ctx context.Context, req *connect.Request[v3.Request]) (*connect.ServerStreamForClient[v2.Response], error) {
...
func NewStreamHandler(svc StreamHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/sf.substreams.rpc.v3.Stream/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedStreamHandler) Blocks(context.Context, *connect.Request[v3.Request], *connect.ServerStream[v2.Response]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("sf.substreams.rpc.v3.Stream.Blocks is not implemented"))
}
