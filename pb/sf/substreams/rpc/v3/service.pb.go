...
type Request struct {
	...
	PartialBlocksOnly bool `protobuf:"varint,15,opt,name=partial_blocks_only,json=partialBlocksOnly,proto3" json:"partial_blocks_only,omitempty"`
...
const file_sf_substreams_rpc_v3_service_proto_rawDesc = "" +
	"\n" +
	"\"sf/substreams/rpc/v3/service.proto\x12\x14sf.substreams.rpc.v3\x1a\x19google/protobuf/any.proto\x1a\x1dsf/firehose/v2/firehose.proto\x1a\"sf/substreams/rpc/v2/service.proto\x1a\x1csf/substreams/v1/clock.proto\x1a\x1esf/substreams/v1/modules.proto\x1a\x1esf/substreams/v1/package.proto\"\x8c\x06\n" +
	"\aRequest\x12&\n" +
	...
	"\x13partial_blocks_only\x18\x0f \x01(\bR\x11partialBlocksOnly\x1a9\n" +
