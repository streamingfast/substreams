...
func (c *streamClient) Blocks(ctx context.Context, in *Request, opts ...grpc.CallOption) (Stream_BlocksClient, error) {
	stream, err := c.cc.NewStream(ctx, &Stream_ServiceDesc.Streams[0], "/sf.substreams.rpc.v3.Stream/Blocks", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamBlocksClient) Recv() (*v2.Response, error) {
	m := new(v2.Response)
...
func (x *streamBlocksServer) Send(m *v2.Response) error {
