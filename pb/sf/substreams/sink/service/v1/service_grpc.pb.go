...
const (
	Provider_Deploy_FullMethodName = "/sf.substreams.sink.service.v1.Provider/Deploy"
	Provider_Update_FullMethodName = "/sf.substreams.sink.service.v1.Provider/Update"
	Provider_Info_FullMethodName   = "/sf.substreams.sink.service.v1.Provider/Info"
	Provider_List_FullMethodName   = "/sf.substreams.sink.service.v1.Provider/List"
	Provider_Pause_FullMethodName  = "/sf.substreams.sink.service.v1.Provider/Pause"
	Provider_Stop_FullMethodName   = "/sf.substreams.sink.service.v1.Provider/Stop"
	Provider_Resume_FullMethodName = "/sf.substreams.sink.service.v1.Provider/Resume"
	Provider_Remove_FullMethodName = "/sf.substreams.sink.service.v1.Provider/Remove"
)
...
func (c *providerClient) Deploy(ctx context.Context, in *DeployRequest, opts ...grpc.CallOption) (*DeployResponse, error) {
	...
	err := c.cc.Invoke(ctx, Provider_Deploy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Provider_Info_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerClient) Pause(ctx context.Context, in *PauseRequest, opts ...grpc.CallOption) (*PauseResponse, error) {
	...
	err := c.cc.Invoke(ctx, Provider_Pause_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerClient) Resume(ctx context.Context, in *ResumeRequest, opts ...grpc.CallOption) (*ResumeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Provider_Resume_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Provider_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Provider_Info_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Provider_Pause_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Provider_Pause_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Provider_Resume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Provider_Resume_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
