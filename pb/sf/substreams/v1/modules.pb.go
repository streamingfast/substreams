...
const file_sf_substreams_v1_modules_proto_rawDesc = "" +
	"\n" +
	"\x1esf/substreams/v1/modules.proto\x12\x10sf.substreams.v1\"s\n" +
	"\aModules\x122\n" +
	"\amodules\x18\x01 \x03(\v2\x18.sf.substreams.v1.ModuleR\amodules\x124\n" +
	...
	"\n" +
	"kind_store\x18\x03 \x01(\v2\".sf.substreams.v1.Module.KindStoreH\x00R\tkindStore\x12S\n" +
	"\x10kind_block_index\x18\n" +
	" \x01(\v2'.sf.substreams.v1.Module.KindBlockIndexH\x00R\x0ekindBlockIndex\x12!\n" +
	"\fbinary_index\x18\x04 \x01(\rR\vbinaryIndex\x12+\n" +
	"\x11binary_entrypoint\x18\x05 \x01(\tR\x10binaryEntrypoint\x126\n" +
	"\x06inputs\x18\x06 \x03(\v2\x1e.sf.substreams.v1.Module.InputR\x06inputs\x127\n" +
	"\x06output\x18\a \x01(\v2\x1f.sf.substreams.v1.Module.OutputR\x06output\x12#\n" +
	"\rinitial_block\x18\b \x01(\x04R\finitialBlock\x12G\n" +
	"\fblock_filter\x18\t \x01(\v2$.sf.substreams.v1.Module.BlockFilterR\vblockFilter\x1a\xab\x01\n" +
	"\vBlockFilter\x12\x16\n" +
	"\x06module\x18\x01 \x01(\tR\x06module\x12#\n" +
	"\fquery_string\x18\x02 \x01(\tH\x00R\vqueryString\x12V\n" +
	"\x11query_from_params\x18\x03 \x01(\v2(.sf.substreams.v1.Module.QueryFromParamsH\x00R\x0fqueryFromParamsB\a\n" +
	"\x05query\x1a\x11\n" +
	...
	"\tKindStore\x12T\n" +
	"\rupdate_policy\x18\x01 \x01(\x0e2/.sf.substreams.v1.Module.KindStore.UpdatePolicyR\fupdatePolicy\x12\x1d\n" +
	"\n" +
	"value_type\x18\x02 \x01(\tR\tvalueType\"\xdd\x01\n" +
	"\fUpdatePolicy\x12\x17\n" +
	...
	"\vmodule_name\x18\x01 \x01(\tR\n" +
	"moduleName\x12=\n" +
	"\x04mode\x18\x02 \x01(\x0e2).sf.substreams.v1.Module.Input.Store.ModeR\x04mode\"&\n" +
	"\x04Mode\x12\t\n" +
	"\x05UNSET\x10\x00\x12\a\n" +
	"\x03GET\x10\x01\x12\n" +
	"\n" +
	"\x06DELTAS\x10\x02\x1a\x1e\n" +
	"\x06Params\x12\x14\n" +
