...
func (*StoreData) Descriptor() ([]byte, []int) {
	return file_sf_substreams_v1_substreams_proto_rawDescGZIP(), []int{13}
}
...
func (x *ModuleProgress_Failed) Reset() {
	*x = ModuleProgress_Failed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sf_substreams_v1_substreams_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_sf_substreams_v1_substreams_proto_rawDesc = []byte{
	...
	,
...
var file_sf_substreams_v1_substreams_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_sf_substreams_v1_substreams_proto_goTypes = []interface{}{
	...
	(*StoreData)(nil),                     // 15: sf.substreams.v1.StoreData
	(*ModuleProgress_ProcessedRange)(nil), // 16: sf.substreams.v1.ModuleProgress.ProcessedRange
	(*ModuleProgress_InitialState)(nil),   // 17: sf.substreams.v1.ModuleProgress.InitialState
	(*ModuleProgress_ProcessedBytes)(nil), // 18: sf.substreams.v1.ModuleProgress.ProcessedBytes
	(*ModuleProgress_Failed)(nil),         // 19: sf.substreams.v1.ModuleProgress.Failed
	nil,                                   // 20: sf.substreams.v1.StoreData.KvEntry
	(*Modules)(nil),                       // 21: sf.substreams.v1.Modules
	(*Clock)(nil),                         // 22: sf.substreams.v1.Clock
...
var file_sf_substreams_v1_substreams_proto_depIdxs = []int32{
	...
	21, // 1: sf.substreams.v1.Request.modules:type_name -> sf.substreams.v1.Modules
	...
	22, // 9: sf.substreams.v1.BlockScopedData.clock:type_name -> sf.substreams.v1.Clock
	0,  // 10: sf.substreams.v1.BlockScopedData.step:type_name -> sf.substreams.v1.ForkStep
	23, // 11: sf.substreams.v1.ModuleOutput.map_output:type_name -> google.protobuf.Any
	...
	16, // 14: sf.substreams.v1.ModuleProgress.processed_ranges:type_name -> sf.substreams.v1.ModuleProgress.ProcessedRange
	17, // 15: sf.substreams.v1.ModuleProgress.initial_state:type_name -> sf.substreams.v1.ModuleProgress.InitialState
	18, // 16: sf.substreams.v1.ModuleProgress.processed_bytes:type_name -> sf.substreams.v1.ModuleProgress.ProcessedBytes
	19, // 17: sf.substreams.v1.ModuleProgress.failed:type_name -> sf.substreams.v1.ModuleProgress.Failed
	...
	24, // 20: sf.substreams.v1.Output.timestamp:type_name -> google.protobuf.Timestamp
	23, // 21: sf.substreams.v1.Output.value:type_name -> google.protobuf.Any
	20, // 22: sf.substreams.v1.StoreData.kv:type_name -> sf.substreams.v1.StoreData.KvEntry
	11, // 23: sf.substreams.v1.ModuleProgress.ProcessedRange.processed_ranges:type_name -> sf.substreams.v1.BlockRange
	2,  // 24: sf.substreams.v1.Stream.Blocks:input_type -> sf.substreams.v1.Request
	3,  // 25: sf.substreams.v1.Stream.Blocks:output_type -> sf.substreams.v1.Response
...
func file_sf_substreams_v1_substreams_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sf_substreams_v1_substreams_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
