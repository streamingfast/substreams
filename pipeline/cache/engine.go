...
func (e *Engine) NewBuffer(block *bstream.Block, clock *pbsubstreamsrpc.Clock, cursor *bstream.Cursor) (execout.ExecutionOutput, error) {
...
func (e *Engine) HandleUndo(clock *pbsubstreamsrpc.Clock) {
	delete(e.reversibleBuffers, clock.Number)
}

func (e *Engine) HandleFinal(clock *pbsubstreamsrpc.Clock) error {
...
func (e *Engine) HandleStalled(clock *pbsubstreamsrpc.Clock) error {
	delete(e.reversibleBuffers, clock.Number)
	return nil
}

func (e *Engine) EndOfStream(lastFinalClock *pbsubstreamsrpc.Clock) error {
	if e.writableFiles != nil {
