...
func TestRustScript(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_SUM, "bigint", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_SUM, "int64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_SUM, "float64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_SUM, "bigFloat", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_MIN, "int64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_MIN, "bigInt", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_MIN, "float64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_MIN, "bigFloat", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_MAX, "int64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_MAX, "bigInt", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_MAX, "float64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_MAX, "bigFloat", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", pbtransform.KindStore_UPDATE_POLICY_IGNORE, "some object", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
