...
func TestRustScript(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_SUM, "bigint", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_SUM, "int64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_SUM, "float64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_SUM, "bigFloat", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_MIN, "int64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_MIN, "bigInt", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_MIN, "float64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_MIN, "bigFloat", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_MAX, "int64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_MAX, "bigInt", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_MAX, "float64", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_MAX, "bigFloat", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
		...
		},
		{
			...
			builder:      state.NewBuilder("builder.name.1", 0, "module.hash", pbtransform.KindStore_UPDATE_POLICY_IGNORE, "some object", nil),
			assert: func(t *testing.T, module *wasm.Module, instance *wasm.Instance, builder *state.Builder) {
	...
	for _, c := range cases {
		t.Run(c.functionName, func(t *testing.T) {
			...
			instance, err := module.NewInstance(c.functionName, nil, pipeline.GetRPCWasmFunctionFactory(nil, module))
			require.NoError(t, err)
	...
	for i := 0; i < 100; i++ {
		...
		for j := 0; j < 100; j++ {
			...
			go func(id int) {
				...
				instance, err := module.NewInstance("test_make_it_crash", nil, pipeline.GetRPCWasmFunctionFactory(nil, module))
