...
func StringToInt256(s string) (proto.Int256, error) {
	...
	if bigInt.Sign() >= 0 {
		...
		if tempBig.BitLen() > 0 { lowHigh = tempBig.Uint64(); tempBig.Rsh(tempBig, 64) }
		if tempBig.BitLen() > 0 { highLow = tempBig.Uint64(); tempBig.Rsh(tempBig, 64) }
		if tempBig.BitLen() > 0 { highHigh = tempBig.Uint64() }
	} else {
		absBigInt := new(big.Int).Abs(bigInt)
		...
		lowLow = tempBig.Uint64()
		tempBig.Rsh(tempBig, 64)
		if tempBig.BitLen() > 0 { lowHigh = tempBig.Uint64(); tempBig.Rsh(tempBig, 64) } else { lowHigh = ^uint64(0) }
		if tempBig.BitLen() > 0 { highLow = tempBig.Uint64(); tempBig.Rsh(tempBig, 64) } else { highLow = ^uint64(0) }
		if tempBig.BitLen() > 0 { highHigh = tempBig.Uint64() } else { highHigh = ^uint64(0) }
	}
	return proto.Int256{Low: proto.UInt128{Low: lowLow, High: lowHigh}, High: proto.UInt128{Low: highLow, High: highHigh}}, nil
}
...
func StringToUInt256(s string) (proto.UInt256, error) {
	...
	var lowLow, lowHigh, highLow, highHigh uint64
	tempBig := new(big.Int).Set(bigInt)
	lowLow = tempBig.Uint64(); tempBig.Rsh(tempBig, 64)
	if tempBig.BitLen() > 0 { lowHigh = tempBig.Uint64(); tempBig.Rsh(tempBig, 64) }
	if tempBig.BitLen() > 0 { highLow = tempBig.Uint64(); tempBig.Rsh(tempBig, 64) }
	if tempBig.BitLen() > 0 { highHigh = tempBig.Uint64() }
	return proto.UInt256{Low: proto.UInt128{Low: lowLow, High: lowHigh}, High: proto.UInt128{Low: highLow, High: highHigh}}, nil
}
