...
# What's working
Functional JS processing for up to ~6000 Ethereum blocks without crashing (last test).
...
Fatal javascript OOM in MemoryChunk allocation failed or Mark-Compact errors.
