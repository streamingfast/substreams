...
func (m *Module) set(ord int64, keyPtr, keyLength, valPtr, valLength int32) {
	...
	key := m.CurrentInstance.Heap.ReadString(keyPtr, keyLength)
	value := m.CurrentInstance.Heap.ReadBytes(valPtr, valLength)
...
func (m *Module) deletePrefix(ord int64, keyPtr, keyLength int32) {
	prefix := m.CurrentInstance.Heap.ReadString(keyPtr, keyLength)
...
func (m *Module) addBigInt(ord int64, keyPtr, keyLength, valPtr, valLength int32) {
	...
	key := m.CurrentInstance.Heap.ReadString(keyPtr, keyLength)
	value := m.CurrentInstance.Heap.ReadString(valPtr, valLength)
