...
| Strategy | Median ns/op | Mean ns/op | Wins (out of 10) |
| -------- | ------------ | ---------- | ---------------- |
| Separate | 10 889 702   | 11 156 733 | 8                |
| Concat   | 12 363 479   | 12 258 636 | 2                |

**Conclusion:** the **Separate** strategy is consistently faster (~12% median improvement) and uses ~40% less memory. The document retains the two-step loading as the default approach.
